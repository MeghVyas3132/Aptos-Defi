  ...
  return (
    <nav className="panel-border border-l-0 border-t-0 border-b-0 bg-bg-panel flex flex-col z-20">
      ...
      <div className="h-16 flex items-center px-4 border-b border-gray-800">
        ...
        <span className="font-bold text-lg tracking-wider text-white">FIN-AI</span>
      </div>
      ...
      <div className="p-4 border-t border-gray-800 bg-black/20">
        <div className="flex items-center mb-1">
          ...
          <div className="ml-3 overflow-hidden">
            <p className="text-xs text-white font-semibold">User_0x8...A9</p>
            <p className="text-[10px] text-green-400">● Live Feed Active</p>
          </div>
        </div>
      </div>
    </nav>
